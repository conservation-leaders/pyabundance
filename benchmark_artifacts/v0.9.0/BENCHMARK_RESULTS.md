...
Correctness:
	...
	•	parity status: close
Performance:
	•	Python full fit median time: 0.0608631
	•	R full fit median time: 0.542
	•	speed ratio R/Python: 8.90523
	...
	•	Python direct likelihood median time: 0.619916 ms (619.916 µs)
Environment:
...
Notes:
	...
	•	Bottleneck appears dominated by optimizer likelihood calls: nfev × direct likelihood median ≈ 0.0595s (97.8% of median fit time).
