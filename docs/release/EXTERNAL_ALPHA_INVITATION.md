...
1. Install from TestPyPI or a GitHub Actions wheel artifact.
...
5. Record feedback in the pyabundance Linear project using the reviewer feedback template. Ask the
   release coordinator for workspace access if needed.
