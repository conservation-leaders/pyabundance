...
pyabundance separates high-level Python orchestration from Rust numerical kernels.
...
- `analyze_pcount()` orchestrates existing fitted models; it does not replace Rust-backed fitting.
